...
local config = {
  ...
  options = {
    opt = {
      ...
      shell = "/usr/local/bin/fish", -- change default shell to fish
  ...
  mappings = {
    ...
    n = {
      ...
      ["<leader>tp"] = { function() toggle_term_cmd "python3" end, desc = "ToggleTerm python3" },
      ["<leader>D"] = { "<cmd>cd %:p:h<cr>", desc = "Change working dir to location of current buffer" },
    },
    t = {
  ...
  plugins = {
    init = {
      ...
      {
        "ggandor/leap.nvim",
        config = function() require "user.leap-cfg" end,
      },
  ...
  -- Override some heirline settings
